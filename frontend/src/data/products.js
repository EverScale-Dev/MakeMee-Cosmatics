...
export const products = [
  {
    ...
    category: "Serums",
    images: [faceserum2, faceserum1, faceserum3],
    rating: 4.8,
    reviews: 234,
    inStock: true,
...

  {
    ...
    category: "Lip Care",
    images: [facewash1, facewash3, facewash2],
    rating: 4.6,
    reviews: 156,
    inStock: true,
...

  {
    ...
    category: "Face Oils",
    images: [moisturizer3, moisturizer2, moisturizer1],
    rating: 4.9,
    reviews: 98,
    inStock: true,
...

  {
    ...
    category: "Eye Care",
    images: [antiaging1, antiaging3, antiaging2],
    rating: 4.5,
    reviews: 143,
    inStock: true,
